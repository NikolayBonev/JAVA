...
public class DepedenciesResolving {
	...
	public DepedenciesResolving(){
		...
		setPathPackages("../DepedenciesResolving/depedencies/all_packages.json");
		setPathDependencies("../DepedenciesResolving/depedencies/dependencies.json");
		setPathInstalledModuls("../DepedenciesResolving/depedencies/installed_modules/");
		
		searchInstalledModuls();
	}
	...
	private void searchInstalledModuls(){
		File file = new File(getPathInstalledModuls());
		
		String[] files = file.list();
		ArrayList<String> dir = new ArrayList<String>();
		
		for(String name : files){
			if(new File(getPathInstalledModuls()+name).isDirectory()){
				dir.add(name);
			}
		}
	...
	private void loadDataBase(){
		...
		try {
			reader = new BufferedReader(new FileReader(getPathPackages()));
	...
	private void depedenciesMaker(){	
		BufferedReader reader;
		
		try {
			reader = new BufferedReader(new FileReader(getPathDependencies()));
